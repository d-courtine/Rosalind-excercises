...
from −10^5 to 10^5,
Return: For each array A[1..n], output three different indices 1≤p<q<r≤n such that A[p]+A[q]+A[r]=0
if exist, and "-1" otherwise.
"""

"""
IT CAN WORK THIS WAY, BUT the code has to test n * (n-1) * (n-2) combinations for each array, which
can be up to 9.10^11
"""
...
with open("rosalind_3sum.txt", "r" ) as f:
    ...
    for line in lines:
        ...
        result = list(map(str, three_sum(array))) #get the result as a list of str()
